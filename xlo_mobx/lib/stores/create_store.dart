...
/*   _CreateStore(this.ad);
  ...
  @computed
  bool get formValid => imagesValid && titleValid && descriptionValid && descriptionValid && categoryValid && addressValid && priceValid;
  ...
  Future<void> _send() async {
    ...
    ad.images = images;
    ad.address = address;
    ad.user = GetIt.I<UserManagerStore>().user; // pega o usuário atual

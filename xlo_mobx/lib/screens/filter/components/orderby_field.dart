    ...
    Widget buildOption(String title, OrderBy option) {
      return GestureDetector(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: filter.orderBy == option ? Colors.purple : Colors.grey),
        ),
        child: Text(title, style: TextStyle(color:filter.orderBy == option ? Colors.white : Colors.black))
      ),
      );
    }

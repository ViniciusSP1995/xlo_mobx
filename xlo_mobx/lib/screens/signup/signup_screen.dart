            ...
            child: Card(
                        ...
                        child: Padding(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Observer(
                                builder: (_) {
                                  return TextField(
                                    ...
                                    decoration: InputDecoration(border: OutlineInputBorder(), hintText: 'Exemplo: João S.', 
                              isDense: true,
                              ...
                              FieldTitle(
                                title: 'E-mail',
                                subtitle: 'Enviaremos u  email de confirmação.',
                              ),
                              Observer(
                                builder: (_) {
                                  return TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'Exemplo: jogo@gmail.com',
                                  isDense: true,
                              ...
                              Observer(
                                builder: (_) {
                                  return TextField(
                                    enabled: !signupStore.loading,
                                    decoration: InputDecoration(border: OutlineInputBorder(), hintText: '(99) 99999-9999', isDense: true,
                              ...
                              Observer(
                                builder: (_) {
                                  return TextField(
                                enabled: !signupStore.loading,
                                decoration: InputDecoration(border: OutlineInputBorder(), isDense: true, errorText: signupStore.pass2Error,
                                ),
                                obscureText: true,
